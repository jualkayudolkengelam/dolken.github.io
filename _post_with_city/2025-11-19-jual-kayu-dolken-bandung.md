...
- Sumur Bandung (Braga, Kebon Pisang, Babakan Ciamis)
- Cidadap (Hegarmanah, Ledeng, Ciumbuleuit)
- Antapani (Antapani Tengah, Antapani Kulon)
- Arcamanik (Cisaranten Kulon, Sukamiskin)
- Bandung Kidul (Wates, Batununggal, Mengger)
...
finalisasi_pengiriman:
  konfirmasi_pesanan: Konfirmasi detail pesanan Anda - pastikan jumlah batang, ukuran
    diameter, dan alamat pengiriman di Bandung sudah benar untuk kelancaran proses.
  pengiriman_gratis: Pengiriman gratis menggunakan armada terpercaya ke seluruh wilayah
    Bandung dari pusat kota hingga Lembang. Dijamin tepat waktu dan aman sampai lokasi
    proyek Anda.
