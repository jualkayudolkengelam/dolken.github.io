...
# ============================================================================
# File: 2025-11-15-jual-kayu-dolken-terdekat.md
# Purpose: Artikel untuk jual kayu dolken terdekat (general / multi-region)
...
images:
  - /assets/images/posts/jual-kayu-dolken-terdekat/jual-kayu-dolken-terdekat-001.webp
images_alt:
  - "Proses loading kayu dolken gelam ke truk untuk pengiriman ke Jakarta Bogor Bandung Tangerang Bekasi dan sekitarnya"
...
area_pengiriman:
  ...
  - "Tangerang (Kota, Kabupaten, BSD, Serpong)"
  - "Bekasi (Kota, Kabupaten, Cikarang, Tambun)"
  - "Bogor (Kota, Kabupaten, Cibinong, Sentul)"
  - "Depok (Margonda, Pancoran Mas, Beji)"
  - "Bandung (Kota, Kabupaten, Cimahi)"
  - "Karawang (KIIC, Cikampek, Telukjambe)"
  - "Semarang (Kota, Kabupaten, Ungaran)"
  - "Surabaya (Kota, Sidoarjo, Gresik)"
...
area_pengiriman_detail:
  judul_jangkauan: "Jangkauan Pengiriman Luas ke Seluruh Jawa & Bali"
  deskripsi_jangkauan: "Kami melayani pengiriman kayu dolken gelam ke seluruh wilayah Jawa dan Bali mencakup kota-kota besar seperti Jakarta, Bandung, Semarang, Surabaya, hingga Denpasar. Gratis ongkir untuk area tertentu dengan minimal pembelian."

  judul_pusat: "Wilayah Jabodetabek"
  deskripsi_pusat: "Area strategis meliputi Jakarta, Bogor, Depok, Tangerang, dan Bekasi dengan akses mudah ke kawasan bisnis dan residensial. Melayani pengiriman cepat 1-3 hari kerja ke seluruh Jabodetabek."

  judul_utara_selatan: "Wilayah Jawa Barat & Jawa Tengah"
  deskripsi_utara_selatan: "Kawasan Bandung, Cimahi, Purwakarta, Semarang, dan sekitarnya dengan pertumbuhan industri dan properti pesat. Melayani kebutuhan material konstruksi residensial, komersial, dan industri."

  judul_pengembangan: "Wilayah Jawa Timur & Bali"
  deskripsi_pengembangan: "Wilayah berkembang seperti Surabaya, Sidoarjo, Malang, serta Denpasar, Gianyar, dan Badung di Bali. Banyak proyek properti dan pariwisata membutuhkan material berkualitas."

  judul_lainnya: "Kota Lainnya di Jawa-Bali"

  judul_landmark: "Kawasan Strategis & Komersial"
  deskripsi_landmark: "Melayani pengiriman ke kawasan strategis seperti BSD City, Alam Sutera, Cikarang, JIIPE Gresik, dan berbagai kawasan industri. Ideal untuk proyek komersial, perumahan, dan infrastruktur."

  judul_wisata: "Destinasi & Landmark Jawa-Bali"
  deskripsi_wisata: "Jangkauan meliputi destinasi populer seperti Puncak Bogor, Kawah Putih Bandung, Lawang Sewu Semarang, Bromo Probolinggo, hingga pantai-pantai indah di Bali seperti Kuta, Sanur, dan Nusa Dua."

  judul_fasilitas: "Fasilitas Pendidikan & Komersial"
  deskripsi_fasilitas: "Melayani kebutuhan kampus besar seperti UI, ITB, UGM, ITS, Unud, mall-mall ternama, serta kawasan komersial dan industri untuk konstruksi dan renovasi."
...
finalisasi_pengiriman:
  konfirmasi_pesanan: "Konfirmasi detail pesanan Anda - pastikan jumlah batang, ukuran diameter, dan alamat pengiriman sudah benar untuk kelancaran proses pengiriman ke lokasi Anda."
  pengiriman_gratis: "Pengiriman menggunakan armada terpercaya ke seluruh wilayah Jawa-Bali dari Jabodetabek, Bandung, Semarang, Surabaya hingga Bali. Gratis ongkir area tertentu. Dijamin tepat waktu dan aman sampai lokasi proyek Anda."
  bayar_cod: "Sistem pembayaran fleksibel: COD untuk retail, invoice/termin untuk perusahaan dan kontraktor. Cek kualitas dulu sebelum bayar - aman, tanpa risiko, dan terpercaya."
...
# ============================================================================
tips_ukuran:
  - kategori: "Aplikasi Dekoratif"
    aplikasi: "Pagar Taman, Border Tanaman, Dekorasi Outdoor"
    diameter: "2-3 cm / 4-6 cm"
    keunggulan:
      - "Ringan dan mudah dipasang sendiri"
      - "Perfect untuk landscaping rumah dan villa"
      - "Harga terjangkau untuk proyek skala kecil"
    warna: "success"
    icon: "bi-tree"
  - kategori: "Konstruksi Menengah"
    aplikasi: "Gazebo, Pergola, Furniture Outdoor"
    diameter: "6-8 cm"
    keunggulan:
      - "Kekuatan optimal untuk beban menengah"
      - "Ideal untuk gazebo, pergola, dan deck"
      - "Balance sempurna antara kekuatan dan biaya"
    warna: "primary"
    icon: "bi-house-fill"
  - kategori: "Konstruksi Berat"
    aplikasi: "Struktur Bangunan, Warehouse, Pondasi"
    diameter: "8-10 cm / 10-12 cm"
    keunggulan:
      - "Kekuatan maksimal untuk beban berat"
      - "Cocok untuk warehouse, bangunan komersial"
      - "Daya tahan ekstrem untuk proyek skala besar"
    warna: "danger"
...
<section id="hero-jual-kayu-dolken">
  {% include reusable/block--hero-jual-kayu-dolken-terdekat.html %}
</section>
